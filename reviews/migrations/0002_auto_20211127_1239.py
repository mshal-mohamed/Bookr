    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publicatin_date', models.DateField(verbose_name='Date the book was published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_names', models.CharField(help_text='The contributor first_name or names.', max_length=50)),
                ('last_names', models.CharField(help_text='The contributor last name or name.', max_length=50)),
