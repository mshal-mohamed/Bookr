...
class Contributor(models.Model):
    ...
    first_names = models.CharField(max_length=50, help_text="The contributor first_name or names.")
    last_names = models.CharField(max_length=50, help_text="The contributor last name or name.")
